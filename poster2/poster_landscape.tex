...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  \begin{tabular}{  p{1.6cm} p{13.cm} }
   {\bf Study \newline population} & \textbullet~153 elderly males from the Normative Aging Study \\
    ...
    \hline
    {\bf Exposure} & \textbullet~Fine PM ($PM_{2.5}$), black carbon (BC), organic carbon (OC) and sulfates ($SO_4^{2-}$) measured at a stationary ambient monitoring site. Exposure in different time windows [4-hours to 28-days moving averages (MA)] \\
