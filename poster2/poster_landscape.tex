...
\begin{itemize} \compresslist
  \item The classifier could predict if in currently a city has influential air pollution to DNA of the citizens in general: YES, NO (the simplest version of classifier);
  \item more complex prediction model that is based on neural nets could give measurable output for some Epigenetic interests.
\end{itemize}
  {\bf Input Data from}:
  \begin{itemize} \compresslist
    \item random 150 male citizens with reproductive age 18-40 years old;
